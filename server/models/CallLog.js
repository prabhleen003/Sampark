...
const callLogSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ['message', 'call', 'sms', 'emergency'],
      required: true,
    },
    ...
    exotel_session_id: { type: String, default: null },
    sms_sid:           { type: String, default: null, index: true },
    sms_status:        { type: String, enum: ['sent', 'delivered', 'failed', null], default: null },
    owner_reply:       { type: String, default: null },
    owner_replied_at:  { type: Date, default: null },
    message_text:      { type: String, default: null },
    message_template:  { type: String, default: null },
    ...
    is_emergency_sms:    { type: Boolean, default: false },
    emergency_contact_label: { type: String, default: null },
  },
